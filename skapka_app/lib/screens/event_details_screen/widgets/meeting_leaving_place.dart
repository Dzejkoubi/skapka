...
class MeetingLeavingPlace extends StatelessWidget {
  const MeetingLeavingPlace({super.key, required this.event});
                    ...
                    MainButton.text(
                      ...
                      onPressed: () {
                        Clipboard.setData(
                          ClipboardData(
                            text:
                                '${context.localizations.create_edit_event_screen_meeting_place_text}: ${event.meetingPlace!}\n${context.localizations.create_edit_event_screen_leave_place_text}: ${event.leavingPlace!}',
                          ),
                        );
                        BottomDialog.show(
                          context,
